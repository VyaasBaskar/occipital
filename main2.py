...
while True:
    ...
    #TODO: send detections_parsed, here
    #cls is an int
    #for tx_l, tx_r, d, h in detections_parsed:
    #multiply by 100. cast to int. Send this over instead of floats.
    # you may need to move the class "Detection" over to V5Comm instead of the funny AIRecord thingy they use
    # remove all the classes they give and we don't use
    # remove all the useless stuff they send but we don't need to
